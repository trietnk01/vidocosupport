<?php
class ModuleProduct extends WP_Widget {

	public function __construct() {		
		$id_base = 'module-product';
		$name	= 'ModuleProduct';
		$widget_options = array(
					'classname' => 'module-product',
					'description' => 'ModuleProduct'
				);
	...
	public function widget( $args, $instance ) {			
		...
		require PLUGIN_PATH . DS . 'module'. DS .'html'. DS .'module-product.php';		
		echo $after_widget;						
	}
