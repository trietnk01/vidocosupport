jQuery(document).ready(function($){
	...
	if(post_type == 'zaproduct'){
		...
		if(taxonomy == 'za_product_trade'){
			var url ='edit-tags.php?taxonomy=za_product_trade&post_type=zaproduct';
			$(elemt + " a[href='" + url + "']").addClass('current').parent().addClass('current');
		}
		...
		if(taxonomy == 'za_unit'){  
			var url ='edit-tags.php?taxonomy=za_unit&post_type=zaproduct';
			$(elemt + " a[href='" + url + "']").addClass('current').parent().addClass('current');
		}
